...
public sealed class ResultConversionExtensionsTests
{
   ...
   public void ToResponse_CreatesResponseWithCopiedValues()
   {
      ...
      AssertMetadataCopied(result.Metadata, response.Metadata);
   ...
   public void ToResult_FromNonGenericResponse_CreatesResultWithCopiedValues()
   {
      ...
      AssertMetadataCopied(response.Metadata, result.Metadata);
   ...
   public void ToTypedResponse_CreatesTypedResponseWithCopiedValuesAndData()
   {
      ...
      AssertMetadataCopied(response.Metadata, typedResponse.Metadata);
   ...
   public void ToNonGenericResponse_DropsDataAndCopiesValues()
   {
      ...
      AssertMetadataCopied(response.Metadata, nonGenericResponse.Metadata);
   ...
   [Fact]
   public void ToResponse_WhenResultIssuesAreNull_UsesEmptyIssues()
   {
      var result = new TestResult
      {
         Issues = null!
   ...
   [Fact]
   public void ToResponse_WhenResultMetadataIsNull_UsesEmptyMetadata()
   {
      var result = new TestResult
      {
         Metadata = null!
   ...
   [Fact]
   public void ToTypedResponse_WhenResponseIssuesAreNull_UsesEmptyIssues()
   {
      var response = new TestResponse
      {
         Issues = null!
      ...
      Assert.NotNull(typedResponse.Issues);
      Assert.Empty(typedResponse.Issues);
   }

   [Fact]
   public void ToTypedResponse_WhenResponseMetadataIsNull_UsesEmptyMetadata()
   {
      var response = new TestResponse
      {
         Metadata = null!
      ...
      Assert.NotNull(typedResponse.Metadata);
      Assert.True(typedResponse.Metadata.IsEmpty);
   }
   ...
   private sealed class TestResult : IResult
   {
      ...
      public bool HasWarnings =>
         Status == ResultStatus.SuccessWithWarnings
         || Issues?.HasWarningsOrErrors() == true;
   }
