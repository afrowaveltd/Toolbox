...
public sealed class ErrorProfileSelectionServiceNullExcludeErrorsCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenProfileExcludeErrorsCollectionIsNull_ReturnsInvalidResponse()
    {
