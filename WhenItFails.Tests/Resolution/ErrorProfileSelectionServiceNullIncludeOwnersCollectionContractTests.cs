...
public sealed class ErrorProfileSelectionServiceNullIncludeOwnersCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenProfileIncludeOwnersCollectionIsNull_ReturnsInvalidResponse()
    {
