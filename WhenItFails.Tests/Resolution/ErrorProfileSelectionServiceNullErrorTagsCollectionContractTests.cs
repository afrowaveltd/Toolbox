...
public sealed class ErrorProfileSelectionServiceNullErrorTagsCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenErrorTagsCollectionIsNull_ReturnsInvalidResponse()
    {
