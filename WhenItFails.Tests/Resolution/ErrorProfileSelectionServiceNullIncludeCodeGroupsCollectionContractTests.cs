...
public sealed class ErrorProfileSelectionServiceNullIncludeCodeGroupsCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenProfileIncludeCodeGroupsCollectionIsNull_ReturnsInvalidResponse()
    {
