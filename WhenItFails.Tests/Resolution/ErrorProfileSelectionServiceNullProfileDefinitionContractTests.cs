...
public sealed class ErrorProfileSelectionServiceNullProfileDefinitionContractTests
{
    [Fact]
    public void ResolveByProfileName_ShouldReturnInvalidResponse_WhenProfilesContainNullDefinition()
    {
