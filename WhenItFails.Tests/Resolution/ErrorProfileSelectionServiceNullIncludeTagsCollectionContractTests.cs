...
public sealed class ErrorProfileSelectionServiceNullIncludeTagsCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenProfileIncludeTagsCollectionIsNull_ReturnsInvalidResponse()
    {
