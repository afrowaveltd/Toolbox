...
public sealed class ErrorProfileSelectionServiceNullIncludeCategoriesCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenProfileIncludeCategoriesCollectionIsNull_ReturnsInvalidResponse()
    {
