...
public sealed class ErrorProfileSelectionServiceNullIncludeSubcategoriesCollectionContractTests
{
    [Fact]
    public void ResolveByProfileName_WhenProfileIncludeSubcategoriesCollectionIsNull_ReturnsInvalidResponse()
    {
