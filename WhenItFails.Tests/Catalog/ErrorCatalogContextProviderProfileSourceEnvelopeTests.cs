...
public sealed class ErrorCatalogContextProviderProfileSourceEnvelopeTests
{
    [Fact]
    public async Task LoadFromJsonsAsync_ShouldPreserveFullProfileSourceEnvelopeAndUseOnlyFirstIssue()
    {
        const string sourceMessage = "The source profile catalog provider rejected the catalog.";
        const string firstSourceCode = "SourceProfileCatalogRejected";
        ...
        ErrorCatalogContextProvider provider = new(
            ...
            new FullSourceInvalidProfileCatalogProvider(
                sourceMessage,
                firstSourceCode,
                "SecondaryProfileDiagnostic"));
    ...
    private sealed class FullSourceInvalidProfileCatalogProvider(
        string message,
        string firstCode,
        string secondCode)
