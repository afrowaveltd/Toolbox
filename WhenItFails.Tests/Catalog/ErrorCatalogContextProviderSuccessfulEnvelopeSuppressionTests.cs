...
public sealed class ErrorCatalogContextProviderSuccessfulEnvelopeSuppressionTests
{
    [Fact]
    public async Task LoadFromJsonsAsync_ShouldPreserveProviderIssueButSuppressProviderMessageAndMetadata()
    {
        ...
        Response<ErrorCatalogProviderPayload> sourceResponse = new()
        {
            ...
            [
                IssueInfoFactory.Information(
                    informationCode,
                    "The provider supplied additional diagnostic information.")
            ],
