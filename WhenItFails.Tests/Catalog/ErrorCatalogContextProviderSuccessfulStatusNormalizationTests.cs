...
public sealed class ErrorCatalogContextProviderSuccessfulStatusNormalizationTests
{
    [Fact]
    public async Task LoadFromJsonsAsync_ShouldNormalizeSuccessWithWarningsToSuccess_WhenOnlyInformationExists()
    {
        const string informationCode = "ErrorCatalogProviderInformation";
        const string providerMessage = "The provider declared success with warnings.";
        ...
        Response<ErrorCatalogProviderPayload> sourceResponse = new()
        {
            ...
            [
                IssueInfoFactory.Information(
                    informationCode,
                    "The provider supplied informational context only.")
            ],
    ...
    [Fact]
    public async Task LoadFromJsonsAsync_ShouldNormalizeSuccessToSuccessWithWarnings_WhenWarningExists()
    {
        const string warningCode = "ErrorCatalogProviderWarning";
        const string providerMessage = "The provider declared plain success.";
        const string metadataKey = "provider-source";
