...
public sealed class CatalogProviderPipelineNullFirstIssueContractTests
{
    [Fact]
    public async Task LoadNormalizeValidateAsync_ShouldUseFallbackCode_WhenFirstLoaderIssueIsNull()
    {
