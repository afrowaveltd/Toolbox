...
public sealed class JsonsBootstrapperExistingDirectoryCategoryCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenCategoryCatalogFileNameResolvesToExistingDirectory_ReturnsInvalidBeforeProvider()
    {
