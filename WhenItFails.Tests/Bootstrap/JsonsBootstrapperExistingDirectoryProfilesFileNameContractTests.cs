...
public sealed class JsonsBootstrapperExistingDirectoryProfilesFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenProfilesFileNameResolvesToExistingDirectory_ReturnsInvalidBeforeProvider()
    {
