...
public sealed class JsonsBootstrapperExistingFileRootDirectoryContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenRootDirectoryPathIsExistingFile_ReturnsInvalidBeforeProvider()
    {
        ...
        try
        {
            ...
            File.WriteAllText(rootDirectory, "Keep me.");
