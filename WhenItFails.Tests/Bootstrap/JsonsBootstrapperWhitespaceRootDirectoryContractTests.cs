...
public sealed class JsonsBootstrapperWhitespaceRootDirectoryContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenRootDirectoryIsWhitespace_ReturnsInvalidWithoutCreatingWorkspace()
    {
