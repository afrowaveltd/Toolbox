...
public sealed class JsonsBootstrapperNestedParentDirectoryProfilesFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenProfilesFileNameEndsWithParentDirectorySegment_ReturnsInvalidBeforeProviderOrFilesystem()
    {
