...
public sealed class JsonsBootstrapperInvalidCodeGroupCatalogFileNamePathContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenCodeGroupCatalogFileNameContainsNullCharacter_ReturnsInvalidBeforeProviderOrFilesystem()
    {
            ...
            Response<JsonsBootstrapPayload> response =
                await bootstrapper.EnsureWorkspaceAsync(
                    new JsonsOptions
                    {
                        ...
                        CodeGroupCatalogFileName = "code-groups\0.en.json"
                    });
