...
public sealed class JsonsBootstrapperCurrentDirectoryErrorCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenErrorCatalogFileNameResolvesToPackageDirectory_ReturnsInvalidBeforeProviderOrFilesystem()
    {
