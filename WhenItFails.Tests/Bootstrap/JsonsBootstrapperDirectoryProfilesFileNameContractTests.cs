...
public sealed class JsonsBootstrapperDirectoryProfilesFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenProfilesFileNameEndsWithDirectorySeparator_ReturnsInvalidBeforeProviderOrFilesystem()
    {
