...
public sealed class JsonsBootstrapperCurrentDirectoryPackageDirectoryNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenPackageDirectoryNameResolvesToRoot_ReturnsInvalidBeforeProviderOrFilesystem()
    {
