...
public sealed class JsonsBootstrapperWhitespacePackageDirectoryNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenPackageDirectoryNameIsWhitespace_ReturnsInvalidWithoutCreatingWorkspace()
    {
