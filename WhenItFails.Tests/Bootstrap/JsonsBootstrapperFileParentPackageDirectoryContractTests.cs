...
public sealed class JsonsBootstrapperFileParentPackageDirectoryContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenPackageDirectoryParentIsExistingFile_ReturnsInvalidBeforeProvider()
    {
        ...
        string packageDirectoryName = Path.Combine(
            "Packages",
            "WhenItFails");
