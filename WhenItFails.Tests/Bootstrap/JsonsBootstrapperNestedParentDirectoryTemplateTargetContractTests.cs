...
public sealed class JsonsBootstrapperNestedParentDirectoryTemplateTargetContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenLaterTemplateTargetEndsWithParentDirectorySegment_ReturnsInvalidWithoutPartialWrites()
    {
        ...
        try
        {
            JsonsBootstrapper bootstrapper = new(
                new NestedParentDirectoryTargetTemplateProvider());
    ...
    private sealed class NestedParentDirectoryTargetTemplateProvider
