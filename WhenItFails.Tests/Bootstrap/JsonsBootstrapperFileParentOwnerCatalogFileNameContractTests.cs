...
public sealed class JsonsBootstrapperFileParentOwnerCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenOwnerCatalogFileNameParentIsExistingFile_ReturnsInvalidBeforeProvider()
    {
