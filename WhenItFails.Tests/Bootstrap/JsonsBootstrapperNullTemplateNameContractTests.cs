...
public sealed class JsonsBootstrapperNullTemplateNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenTemplateNameIsNull_ReturnsInvalidBeforeWritingTemplateFile()
    {
    ...
    private sealed class NullNameTemplateProvider
