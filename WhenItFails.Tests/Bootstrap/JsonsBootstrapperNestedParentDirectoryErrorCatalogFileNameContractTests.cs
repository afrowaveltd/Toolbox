...
public sealed class JsonsBootstrapperNestedParentDirectoryErrorCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenErrorCatalogFileNameEndsWithParentDirectorySegment_ReturnsInvalidBeforeProviderOrFilesystem()
    {
