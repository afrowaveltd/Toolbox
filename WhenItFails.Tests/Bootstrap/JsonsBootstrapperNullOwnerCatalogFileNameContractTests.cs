...
public sealed class JsonsBootstrapperNullOwnerCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenOwnerCatalogFileNameIsNull_ReturnsInvalidBeforeProviderOrFilesystem()
    {
