...
public sealed class JsonsBootstrapperInvalidErrorCatalogFileNamePathContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenErrorCatalogFileNameContainsNullCharacter_ReturnsInvalidBeforeProviderOrFilesystem()
    {
            ...
            Response<JsonsBootstrapPayload> response =
                await bootstrapper.EnsureWorkspaceAsync(
                    new JsonsOptions
                    {
                        ...
                        ErrorCatalogFileName = "errors\0.en.json"
                    });
