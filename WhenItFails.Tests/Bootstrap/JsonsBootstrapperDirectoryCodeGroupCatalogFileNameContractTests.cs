...
public sealed class JsonsBootstrapperDirectoryCodeGroupCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenCodeGroupCatalogFileNameEndsWithDirectorySeparator_ReturnsInvalidBeforeProviderOrFilesystem()
    {
