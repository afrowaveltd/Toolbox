...
public sealed class JsonsBootstrapperNestedCurrentDirectoryOwnerCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenOwnerCatalogFileNameEndsWithCurrentDirectorySegment_ReturnsInvalidBeforeProviderOrFilesystem()
    {
