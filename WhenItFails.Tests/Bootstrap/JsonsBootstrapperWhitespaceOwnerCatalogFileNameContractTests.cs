...
public sealed class JsonsBootstrapperWhitespaceOwnerCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenOwnerCatalogFileNameIsWhitespace_ReturnsInvalidBeforeProviderOrFilesystem()
    {
