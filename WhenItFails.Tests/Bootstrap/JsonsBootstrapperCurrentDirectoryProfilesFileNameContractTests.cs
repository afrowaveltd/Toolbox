...
public sealed class JsonsBootstrapperCurrentDirectoryProfilesFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenProfilesFileNameResolvesToPackageDirectory_ReturnsInvalidBeforeProviderOrFilesystem()
    {
