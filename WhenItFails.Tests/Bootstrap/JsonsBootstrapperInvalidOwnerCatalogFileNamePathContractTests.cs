...
public sealed class JsonsBootstrapperInvalidOwnerCatalogFileNamePathContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenOwnerCatalogFileNameContainsNullCharacter_ReturnsInvalidBeforeProviderOrFilesystem()
    {
            ...
            Response<JsonsBootstrapPayload> response =
                await bootstrapper.EnsureWorkspaceAsync(
                    new JsonsOptions
                    {
                        ...
                        OwnerCatalogFileName = "owners\0.en.json"
                    });
