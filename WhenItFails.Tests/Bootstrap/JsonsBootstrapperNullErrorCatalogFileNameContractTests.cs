...
public sealed class JsonsBootstrapperNullErrorCatalogFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenErrorCatalogFileNameIsNull_ReturnsInvalidBeforeProviderOrFilesystem()
    {
