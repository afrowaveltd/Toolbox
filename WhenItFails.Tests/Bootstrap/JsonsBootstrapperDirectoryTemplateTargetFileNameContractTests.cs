...
public sealed class JsonsBootstrapperDirectoryTemplateTargetFileNameContractTests
{
    [Fact]
    public async Task EnsureWorkspaceAsync_WhenTemplateTargetEndsWithDirectorySeparator_ReturnsInvalidBeforeCreatingNestedDirectory()
    {
        ...
        try
        {
            JsonsBootstrapper bootstrapper = new(
                new DirectoryTargetTemplateProvider());
    ...
    private sealed class DirectoryTargetTemplateProvider
