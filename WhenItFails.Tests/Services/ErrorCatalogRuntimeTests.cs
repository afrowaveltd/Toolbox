...
public sealed class ErrorCatalogRuntimeTests
{
    ...
    [Fact]
    public async Task InitializeAsync_ShouldRejectInconsistentRuntimeStatus()
    {
        ErrorCatalogInitializationPayload inconsistentPayload = new()
        {
            Bootstrap = new JsonsBootstrapPayload
            {
                PackageDirectoryPath =
            ...
            // ProjectCatalog cannot be an automatic fallback.
            UsedFallback = true
        };
