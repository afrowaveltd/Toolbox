...
public sealed class ErrorCatalogInitializerTests
{
    ...
    [Fact]
    public async Task InitializeAsync_ShouldKeepPreviousContext_WhenBootstrapFails()
    {
    ...
    [Fact]
    public async Task InitializeAsync_ShouldKeepPreviousContext_WhenContextLoadingFails()
    {
        ErrorCatalogContext previousContext = new();
    ...
    [Fact]
    public async Task InitializeAsync_ShouldReplacePreviousContext_WhenReinitializationSucceeds()
    {
        ErrorCatalogContext previousContext = new();
    ...
    [Fact]
    public async Task InitializeAsync_ShouldKeepPreviousContext_WhenLoadedContextIsNull()
    {
        ErrorCatalogContext previousContext = new();
