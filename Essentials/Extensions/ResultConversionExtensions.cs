...
public static class ResultConversionExtensions
{
   ...
   public static Response ToResponse(this IResult result)
   {
      ...
      return new Response
      {
         ...
         Issues = result.Issues ?? IssueInfoListFactory.Empty(),
         Metadata = result.Metadata?.Copy() ?? MetadataBagFactory.Empty()
      };
   }
   ...
   public static Result ToResult(this IResponse response)
   {
      ...
      return new Result
      {
         ...
         Issues = response.Issues ?? IssueInfoListFactory.Empty(),
         Metadata = response.Metadata?.Copy() ?? MetadataBagFactory.Empty()
      };
   }
