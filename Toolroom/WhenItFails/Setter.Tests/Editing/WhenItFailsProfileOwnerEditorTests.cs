...
public sealed class WhenItFailsProfileOwnerEditorTests
{
    [Fact]
    public async Task ProfileAddOwnerAsync_ShouldAddCanonicalOwnerAndCreateBackup()
    {
    ...
    [Fact]
    public async Task ProfileAddOwnerAsync_ShouldReturnInvalid_WhenOwnerAlreadyIncluded()
    {
        using TemporaryWhenItFailsWorkspace temporaryWorkspace =
            await TemporaryWhenItFailsWorkspace.CreateInitializedAsync();
        ...
        Assert.Contains(
            ...
            issue => issue.Code == "ProfileOwnerAlreadyIncluded");
        AssertNoBackupWasCreated(temporaryWorkspace.WhenItFailsJsonsPath);
    }

    [Fact]
    public async Task ProfileAddOwnerAsync_ShouldReturnNotFound_WhenOwnerDoesNotExist()
    {
        using TemporaryWhenItFailsWorkspace temporaryWorkspace =
            await TemporaryWhenItFailsWorkspace.CreateInitializedAsync();
    ...
    [Fact]
    public async Task ProfileAddOwnerAsync_ShouldReturnNotFound_WhenProfileDoesNotExist()
    {
        using TemporaryWhenItFailsWorkspace temporaryWorkspace =
            await TemporaryWhenItFailsWorkspace.CreateInitializedAsync();
    ...
    public async Task ProfileAddOwnerAsync_ShouldReturnInvalid_WhenRequiredValueIsEmpty(
        string profileName,
        string ownerName,
