...
public sealed class WhenItFailsProfileCodeGroupEditorTests
{
    [Fact]
    public async Task ProfileAddCodeGroupAsync_ShouldAddCanonicalCodeGroupAndCreateBackup()
    {
    ...
    [Fact]
    public async Task ProfileAddCodeGroupAsync_ShouldReturnInvalid_WhenCodeGroupAlreadyIncluded()
    {
        using TemporaryWhenItFailsWorkspace temporaryWorkspace =
            await TemporaryWhenItFailsWorkspace.CreateInitializedAsync();
        ...
        Assert.Contains(
            ...
            issue => issue.Code == "ProfileCodeGroupAlreadyIncluded");
        AssertNoBackupWasCreated(temporaryWorkspace.WhenItFailsJsonsPath);
    }

    [Fact]
    public async Task ProfileAddCodeGroupAsync_ShouldReturnNotFound_WhenCodeGroupDoesNotExist()
    {
        using TemporaryWhenItFailsWorkspace temporaryWorkspace =
            await TemporaryWhenItFailsWorkspace.CreateInitializedAsync();
    ...
    [Fact]
    public async Task ProfileAddCodeGroupAsync_ShouldReturnNotFound_WhenProfileDoesNotExist()
    {
        using TemporaryWhenItFailsWorkspace temporaryWorkspace =
            await TemporaryWhenItFailsWorkspace.CreateInitializedAsync();
    ...
    public async Task ProfileAddCodeGroupAsync_ShouldReturnInvalid_WhenRequiredValueIsEmpty(
        string profileName,
