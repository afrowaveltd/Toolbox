...
public sealed class WhenItFailsDocumentationKeySuggesterOptionsMalformedCategoryCatalogTests
{
    [Fact]
    public async Task SuggestAsync_WithResolvedOptionsAndMalformedCategoryCatalog_ReturnsStructuredFailure()
    {
