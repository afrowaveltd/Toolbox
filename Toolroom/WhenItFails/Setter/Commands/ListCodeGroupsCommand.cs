...
{
    private const string Usage = "list-code-groups <path> [--plain|--json]";
    ...
    public static async Task<int> ExecuteAsync(string[] args)
    {
        ...
        IReadOnlyList<ErrorCodeGroupDefinition> codeGroups =
            summary.CodeGroupCatalog.CodeGroups;
    ...
    {
        CommandInputError.Show(
            code: "InvalidListCodeGroupsOutputArguments",
    ...
    private sealed record ListCodeGroupsResult(
        bool Loaded,
        IReadOnlyList<ErrorCodeGroupDefinition>? CodeGroups,
