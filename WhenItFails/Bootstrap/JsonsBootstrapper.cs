...
public sealed class JsonsBootstrapper : IJsonsBootstrapper
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (!IsPathInsideDirectory(packageDirectoryPath, options.CodeGroupCatalogFileName))
            {
                return Response<JsonsBootstrapPayload>.Invalid(
            ...
            if (!IsPathInsideDirectory(packageDirectoryPath, options.OwnerCatalogFileName))
            {
                return Response<JsonsBootstrapPayload>.Invalid(
            ...
            if (!IsPathInsideDirectory(packageDirectoryPath, options.ProfilesFileName))
            {
                return Response<JsonsBootstrapPayload>.Invalid(
