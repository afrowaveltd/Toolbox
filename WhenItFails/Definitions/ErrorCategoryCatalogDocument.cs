...
/// <summary>
/// Represents a complete catalog document containing error category definitions.
/// </summary>
/// <remarks>
/// Category documents define logical categories used for searching, filtering,
/// profiles, documentation and recommended behavior mappings.
/// </remarks>
public sealed class ErrorCategoryCatalogDocument
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets category definitions contained in this catalog.
    /// </summary>
    [JsonPropertyName("categories")]
    public List<ErrorCategoryDefinition> Categories { get; set; } = new();
}