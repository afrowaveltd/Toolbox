...
/// <summary>
/// Represents a complete catalog document containing error profile definitions.
/// </summary>
/// <remarks>
/// Profile documents define scenario-specific views and behavior recommendations
/// for error catalogs.
/// </remarks>
public sealed class ErrorProfileCatalogDocument
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets profile definitions contained in this catalog.
    /// </summary>
    [JsonPropertyName("profiles")]
    public List<ErrorProfileDefinition> Profiles { get; set; } = new();
}