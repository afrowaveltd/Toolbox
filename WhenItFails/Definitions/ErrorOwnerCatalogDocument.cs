...
/// <summary>
/// Represents a complete catalog document containing error owner definitions.
/// </summary>
/// <remarks>
/// Owner documents define ownership of error code spaces, such as built-in
/// Afrowave errors, application errors, plugin errors or user/customer errors.
/// </remarks>
public sealed class ErrorOwnerCatalogDocument
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets owner definitions contained in this catalog.
    /// </summary>
    [JsonPropertyName("owners")]
    public List<ErrorOwnerDefinition> Owners { get; set; } = new();
}