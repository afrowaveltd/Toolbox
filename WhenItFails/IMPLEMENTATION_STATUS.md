...
## 2026-09-25 — precompiled 0.1.0 consumer strict reinitialization after healthy project activation (verification pending)
...
- Updated English `Docs/Published-Binary-Consumer-Smoke/en.md` and Toolroom usage/README. **New mode pending local execution**, while the six previous binary smoke scenarios are maintainer-confirmed PASS. No production API or xUnit changes; last confirmed complete suite **1445/1445 GREEN**. Next: run strict reinitialization smoke on Windows and record the observed outcome before extending compatibility claims.
