...
## 2026-09-25 — detached owner catalog snapshot (verification pending)
...
- **Verification pending:** six focused cases and expected full **1353/1353 GREEN** if all pass; last maintainer-confirmed full suite **1347/1347 GREEN**. Focused output and compiler warning count for 1347 were not separately reported.
...
- Complete `WhenItFails.Tests` suite: **1347/1347 GREEN**, confirmed locally by maintainer after completed combined catalog/status snapshot tests and test helper correction. The last explicitly confirmed warning-free build was at 1241/1241.
