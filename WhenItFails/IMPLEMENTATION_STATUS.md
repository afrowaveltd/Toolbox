...
## 2026-09-25 — exact previous-context publication selection (verification pending)
...
- Created `WhenItFails/Docs/Recovery-Selection/en.md` and updated README, `Docs/Activation-Status/en.md`, `Docs/Publication-Ownership/en.md`, `Docs/Shared-Store-Concurrency/en.md`, `Docs/Runtime/Public-API.md` and `Docs/Public-API-Stability/en.md`. **Verification pending:** five new cases and expected full **1341/1341 GREEN** if all pass; last maintainer-confirmed complete suite **1336/1336 GREEN**. Existing public interfaces/signatures, public payload JSON shape, published 0.1.0 package and persisted catalog schemas unchanged.
...
- Complete `WhenItFails.Tests` suite: **1336/1336 GREEN**, confirmed locally by maintainer after exact owned-publication activation bridge tests. The last explicitly confirmed warning-free build was at 1241/1241.
