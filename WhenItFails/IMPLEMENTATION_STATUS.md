...
Continue the semantic-directory audit with `CategoryCatalogFileName = Path.Combine("Nested", ".")`. Preserve the one-field-at-a-time workflow and all existing category filename contracts.