...
- Complete `WhenItFails.Tests` suite: **1154/1154 GREEN**, confirmed locally by the maintainer after adding the `ErrorOwnerDefinitionNormalizer` null-input contract.
