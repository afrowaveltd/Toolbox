...
- **Verification pending:** six new cases and expected full **1347/1347 GREEN** if all pass; last maintainer-confirmed suite **1341/1341 GREEN**. Published NuGet version and persisted catalog JSON schemas unchanged.
