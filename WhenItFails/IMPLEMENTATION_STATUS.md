...
## 2026-09-25 — pre-cancelled activation with unchanged precompiled 0.1.0 consumer (verification pending)
...
- Updated English `Docs/Published-Binary-Consumer-Smoke/en.md` and Toolroom README/usage. **Local opt-in run pending**; do not mark this eighth mode PASS until maintainer execution. Production code and xUnit tests unchanged; last confirmed full suite **1445/1445 GREEN**, seven binary smoke scenarios confirmed PASS. Next: run isolated pre-cancelled activation smoke and record actual outcome; cancellation during I/O requires separate deterministic synchronization and cleanup tests.
