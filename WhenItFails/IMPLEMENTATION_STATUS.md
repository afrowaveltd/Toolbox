...
## 2026-09-25 — detached supporting profile catalog snapshot (verification pending)
...
- **Verification pending:** six focused cases and expected full **1365/1365 GREEN** if all pass; last maintainer-confirmed full suite **1359/1359 GREEN**, explicitly reported without errors or compiler warnings. Source development does not change the published NuGet 0.1.0 version or persistent catalog JSON schemas.
...
- Complete `WhenItFails.Tests` suite: **1359/1359 GREEN**, confirmed locally by maintainer after code group snapshot tests, with zero reported compiler warnings/errors.
