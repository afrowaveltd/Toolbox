...
- **Verification pending:** 2 additional focused tests, expected complete suite **1460/1460 GREEN**. Last maintainer-confirmed complete suite is **1458/1458 GREEN**, with 8 binary smoke scenarios PASS. Next: run the focused malformed-partial-workspace class and complete suite; record the observed result and any necessary corrections before further hardening.

## Current verified state

- Complete `WhenItFails.Tests` suite: **1458/1458 GREEN**, confirmed locally by maintainer after initializer/runtime integration over recovered partial workspaces (compiler-warning count not separately reported for this checkpoint).
