...
## 2026-09-25 — queued activation cancellation behind opposing operation (verification pending)
...
- **Verification pending:** 2 additional focused tests, expected complete suite **1447/1447 GREEN**. Last maintainer-confirmed complete suite **1445/1445 GREEN**, plus 8 binary smoke PASS. Next: run the focused class and entire suite, and only then record the observed results.
