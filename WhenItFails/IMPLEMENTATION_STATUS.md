...
- **Verification pending:** rerun the 2 focused integration tests, then the complete suite; expected checkpoint remains **1458/1458 GREEN**. Last maintainer-confirmed complete suite remains **1456/1456 GREEN**, plus 8 binary smoke scenarios PASS. If GREEN, record the checkpoint and audit failure behavior when a preserved existing catalog in the recovered workspace is malformed rather than merely user-modified but valid.
