...
- **Verification pending:** seven new tests and expected full **1300/1300 GREEN** if all pass. Last maintainer-confirmed suite **1293/1293 GREEN**. Existing runtime/store interface members, package version and persisted catalog JSON schemas are unchanged.
