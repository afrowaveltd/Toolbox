...
Continue the semantic-directory audit with `CodeGroupCatalogFileName = Path.Combine("Nested", ".")`. Preserve the one-field-at-a-time workflow and all existing code-group filename contracts.