...
## 2026-09-25 — bridge exact owned publication to default activation paths (verification pending)
...
- **Verification pending:** six focused tests and expected full **1336/1336 GREEN** if all pass; last maintainer-confirmed suite **1330/1330 GREEN**. Published NuGet version, original public interfaces, public initialization payload surface and persisted JSON schemas are unchanged.
...
- Complete `WhenItFails.Tests` suite: **1330/1330 GREEN**, confirmed locally by maintainer after exact context publication ownership tests. The last explicitly confirmed warning-free build was at 1241/1241.
