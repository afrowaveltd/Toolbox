...
Probe `CategoryCatalogFileName = Path.Combine("Nested", "Sub", "..")` for the same contained terminal-parent-directory behavior. Preserve true outside-package classification and valid nested category filenames.